...
<div class="grid grid-cols-[15%_10%_40%_45%] gap-y-4 ml-4">
  <div class="text-sm font-bold font-sans">Semester:</div>
  <div class="text-sm font-bold font-sans">Course:</div>
